...
import type { Bilingual, PracticeSet } from "@/lib/content";
...
export const MARATHON_KEY = "Marathon";

export function groupByCategory(sets: PracticeSet[]): CategoryGroup[] {
...
export function StandardCategorySection({ group }: { group: CategoryGroup }) {
  const t = useT();
  return (
    <section>
...
export function StandardCard({ set }: { set: PracticeSet }) {
  const t = useT();
  return (
    <Link
...
export function MarathonSection({ group }: { group: CategoryGroup }) {
  const t = useT();
  return (
    <section>
...
export function MarathonCard({ set }: { set: PracticeSet }) {
  const t = useT();
